# Crypto Signal Vault — guía para Codex
...
Los subagentes del proyecto están en `.Codex/agents/`: orquestador, data-pipe, ml-lab, front-ux, analista-bot, qa-guardian, doc-scribe. Flujo estándar: Orquestador → especialista → QA-Guardian → Doc-Scribe → merge.
